...
def image():
    ...
    if(sign==1):
        ...
        c5.create_text(650,245,font=('chiller',20),text='Of course Bitch!')
...
def phase2(i=0):
    ...
    print (acl)
    c3.create_text(170,70,font=('forte',20),text=acl[0])
...
c1.create_window(50,25,window=l1,height=30)
c1.update()
